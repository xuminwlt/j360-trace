...
import static me.j360.trace.core.internal.Buffer.asciiSizeInBytes;
import static me.j360.trace.core.internal.Buffer.jsonEscapedSizeInBytes;
...
public class BufferTest {
  ...
  static String writeAscii(long v) {
    byte[] buffered = new Buffer(asciiSizeInBytes(v)).writeAscii(v).toByteArray();
    return new String(buffered, Util.UTF_8);
  }
  ...
  public void jsonEscapedSizeInBytes_bytes() throws IOException {
    ...
    assertThat(jsonEscapedSizeInBytes(new byte[] {'\n', '\r', '\f'}))
        .isEqualTo(6);
    assertThat(jsonEscapedSizeInBytes("\u2028 and \u2029".getBytes(Util.UTF_8)))
        .isEqualTo(17);
    assertThat(jsonEscapedSizeInBytes("\"foo".getBytes(Util.UTF_8)))
        .isEqualTo(5);
  }
  ...
  public void writeJsonEscaped_bytes() throws IOException {
    ...
    assertThat(writeJsonEscaped(new byte[] {'\n', '\r', '\f'}))
        .isEqualTo("\\n\\r\\f");
    assertThat(writeJsonEscaped("\u2028 and \u2029".getBytes(Util.UTF_8)))
        .isEqualTo("\\u2028 and \\u2029");
    assertThat(writeJsonEscaped("\"foo".getBytes(Util.UTF_8)))
        .isEqualTo("\\\"foo");
  }
