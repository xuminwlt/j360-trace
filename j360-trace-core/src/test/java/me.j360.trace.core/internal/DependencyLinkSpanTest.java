...
public class DependencyLinkSpanTest {
  ...
  public void whenNoServiceLabelsExist_kindIsUnknown() {
    ...
    assertThat(span.kind).isEqualTo(DependencyLinkSpan.Kind.UNKNOWN);
  ...
  public void whenOnlyAddressLabelsExist_kindIsClient() {
    ...
    assertThat(span.kind).isEqualTo(DependencyLinkSpan.Kind.CLIENT);
  ...
  public void whenSrServiceExists_kindIsServer() {
    ...
    assertThat(span.kind).isEqualTo(DependencyLinkSpan.Kind.SERVER);
