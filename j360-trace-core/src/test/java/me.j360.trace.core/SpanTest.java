...
public class SpanTest {
  ...
  public void mergeWhenBinaryAnnotationsSentSeparately() {
    Span part1 = Span.builder()
        ...
        .name("")
        .id(1L)
        .addBinaryAnnotation(BinaryAnnotation.address(Constants.SERVER_ADDR, TestObjects.APP_ENDPOINT))
        .build();
    ...
    Span part2 = Span.builder()
        ...
        .duration(376000L)
        .addAnnotation(Annotation.create(1444438900939000L, Constants.SERVER_RECV, TestObjects.APP_ENDPOINT))
        .addAnnotation(Annotation.create(1444438901315000L, Constants.SERVER_SEND, TestObjects.APP_ENDPOINT))
        .build();
  ...
  public void serviceNames_includeBinaryAnnotations() {
    ...
    assertThat(span.serviceNames())
        .containsOnly(TestObjects.APP_ENDPOINT.serviceName);
  }
  ...
  public void serviceNames_ignoresAnnotationsWithEmptyServiceNames() {
    Span span = Span.builder()
        ...
        .addAnnotation(Annotation.create(2L, Constants.SERVER_RECV, TestObjects.APP_ENDPOINT))
        .build();
  ...
  public void sortsBinaryAnnotationsByKey() {
    BinaryAnnotation foo = BinaryAnnotation.create("foo", "bar", TestObjects.APP_ENDPOINT);
    BinaryAnnotation baz = BinaryAnnotation.create("baz", "qux", TestObjects.APP_ENDPOINT);
    Span span = Span.builder()
        .traceId(12345)
        .id(666)
        .name("methodcall")
  ...
  public void serializationUsesThrift() throws Exception {
    ...
    byte[] thrift = Codec.JSON.writeSpan(span);
