...
import static me.j360.trace.core.TestObjects.span;
...
public class CollectorTest {
  ...
  public void debugFlagWins() {
    collector.accept(asList(span(Long.MIN_VALUE).toBuilder().debug(true).build()), Callback.NOOP);
  ...
  public void unsampledSpansArentStored() {
    ...
    collector.accept(asList(span(Long.MIN_VALUE)), Callback.NOOP);
