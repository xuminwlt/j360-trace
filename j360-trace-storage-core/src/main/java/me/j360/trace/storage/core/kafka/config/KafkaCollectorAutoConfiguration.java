 ...
 * the License.
 */
package me.j360.trace.storage.core.kafka.config;
...
public class KafkaCollectorAutoConfiguration {

  /**
   * This launches a thread to run start. This prevents a several second hang, or worse crash if
   * zookeeper isn't running, yet.
   */
  @Bean KafkaCollector kafka(KafkaCollectorProperties kafka, CollectorSampler sampler,
