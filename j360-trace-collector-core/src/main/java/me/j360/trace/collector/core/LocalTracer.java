...
import me.j360.trace.collector.core.zipkin.Constants;
...
public abstract class LocalTracer extends AnnotationSubmitter {
    ...
    abstract static class Builder {
        ...
        abstract Builder spanAndEndpoint(SpanAndEndpoint.LocalSpanAndEndpoint spanAndEndpoint);
    ...
    public SpanId startNewSpan(String component, String operation, long timestamp) {
        ...
        newSpan.addToBinary_annotations(
            BinaryAnnotation.create(Constants.LOCAL_COMPONENT, component, spanAndEndpoint().endpoint()));
